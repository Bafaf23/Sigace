      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.institutionInfo}>
            ...
            <Text style={styles.mainTitle}>{"Liecio seleccionado"}</Text>
            <View style={styles.badge}>
              <Text>SISTEMA SIGACE • ID: {data?.user.id || "2026-X"}</Text>
            </View>
          </View>
          ...
          <View style={styles.grid}>
            <View style={[styles.inputGroup, { width: "50%" }]}>
              ...
              <Text style={styles.valueBox}>
                {`${data?.user.name} ${data?.user.lastName}`.toUpperCase()}
              </Text>
            </View>
            ...
            <View style={[styles.inputGroup, { width: "20%" }]}>
              ...
              <Text style={styles.valueBox}>{""}</Text>
            </View>
            <View style={[styles.inputGroup, { width: "30%" }]}>
              <Text style={styles.label}>Nacionalidad</Text>
              <Text style={styles.valueBox}>
                {`${"Venezolana"}`.toUpperCase()}
              </Text>
            </View>
            <View style={[styles.inputGroup, { width: "30%" }]}>
            ...
            <View style={[styles.inputGroup, { width: "30%" }]}>
              ...
              <Text style={styles.valueBox}>{"N/A"}</Text>
            </View>
            <View style={[styles.inputGroup, { width: "30%" }]}>
            ...
            <View style={[styles.inputGroup, { width: "30%" }]}>
              ...
              <Text style={styles.valueBox}>{"NINGUNA"}</Text>
            </View>
            <View style={[styles.inputGroup, { width: "30%" }]}>
