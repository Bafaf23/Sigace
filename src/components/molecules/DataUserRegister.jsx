...
export default function DataUserRegister({ data, manejoCambio }) {
  ...
  return (
    <div className="space-y-3">
      <hr className="mb-5 border border-gray-100" />
      <div className="grid grid-cols-3 place-content-end items-end gap-2">
        <div className="col-span-2">
          <SelectorInput
            ...
            id={"optionId"}
            placeholder={"3242343"}
            valueSel={data.tyDocuement}
            valueInput={data.docuemte}
